...
namespace MersenneTwister.dSFMT
{
    ...
    sealed class dsfmt_opt_gen_t<P> : SFMT.sfmt_base_t, Idsfmt where P : struct, Idsfmt_params
    {
        ...
        private const int DSFMT_SR = 12;

        private static P p = default(P);
        private static int DSFMT_MEXP { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_MEXP; } }
        private static int DSFMT_POS1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_POS1; } }
        private static int DSFMT_SL1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_SL1; } }
        private static ulong DSFMT_MSK1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_MSK1; } }
        private static ulong DSFMT_MSK2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_MSK2; } }
        private static uint DSFMT_MSK32_1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_MSK32_1; } }
        private static uint DSFMT_MSK32_2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_MSK32_2; } }
        private static uint DSFMT_MSK32_3 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_MSK32_3; } }
        private static uint DSFMT_MSK32_4 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_MSK32_4; } }
        private static ulong DSFMT_FIX1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_FIX1; } }
        private static ulong DSFMT_FIX2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_FIX2; } }
        private static ulong DSFMT_PCV1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_PCV1; } }
        private static ulong DSFMT_PCV2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_PCV2; } }
        private static string DSFMT_IDSTR { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return p.DSFMT_IDSTR; } }

        private static int DSFMT_N { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return ((DSFMT_MEXP - 128) / 104 + 1); } }
        private static int DSFMT_N32 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return (DSFMT_N * 4); } }
        private static int DSFMT_N64 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return (DSFMT_N * 2); } }

        private static int DSFMT_N_2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return DSFMT_N * 2; } }
        private static int DSFMT_POS1_2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return DSFMT_POS1 * 2; } }
        private static int DSFMT_POS1_2_sub_DSFMT_N_2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return DSFMT_POS1_2 - DSFMT_N_2; } }
...
#pragma warning restore
        ...
        void dsfmt_gen_rand_all()
        {
            ...
            if (((DSFMT_N_2 - DSFMT_POS1_2) & 2) != 0) {
                do_recursion(status, i, status, i, status, i + DSFMT_POS1_2, ref lung0, ref lung1);
                i += 2;
            }
            if ((i & 2) != 0) {
        ...
        private static uint size {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get {
                return ((uint)DSFMT_N + 1) * 4; /* pulmonary */
            }
        }

        private static uint lag {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get {
                return
                    (size >= 623) ? 11u :
